function [Assignment_elem, problem] = subarrayToAntennaElements(Assignment,conf,problem)
    ...
    elseif strcmp(conf.genStructure, 'allAntennas')
        ...
        num_subarrays_selected = (numel(Assignment))/3;
    
        Taper_value = Assignment((num_subarrays_selected+1):(num_subarrays_selected*2)) .* ...
